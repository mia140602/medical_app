...
class _BookingPageState extends State<BookingPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Container(
        padding:
            EdgeInsets.only(left: 20.w, top: 40.h, right: 20.w, bottom: 40),
          ...
          SliverToBoxAdapter(
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Chọn ngày",
                  style: appstyle(18.sp, AppColor.textColor1, FontWeight.w700),
                ),
                SizedBox(
                  height: 24.h,
                ),
              ...
              ? SliverToBoxAdapter(
                  child: Container(
                    padding: const EdgeInsets.symmetric(
                        horizontal: 10, vertical: 39),
                    alignment: Alignment.center,
                    child: Text(
                      "Không có lịch cuối tuần, hãy chọn lịch khác",
                      style: appstyle(
                          18.sp, AppColor.secondColor, FontWeight.normal),
                    ),
                  ),
                )
              : SliverGrid(
    ...
    return Container(
      ...
      child: TableCalendar(
        ...
        onDaySelected: (selectedDay, focusedDay) async {
          ...
          String doctorId =
              (context.read<DoctorBloc>().state as DoctorSelectedState)
                  .doctor
                  .id;
